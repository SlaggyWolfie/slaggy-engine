...
namespace slaggy
{
	std::unique_ptr<BoxDebug> BoxDebug::_instance = nullptr;

	BoxDebug& BoxDebug::instance()
	{
		if (!_instance) _instance = std::make_unique<BoxDebug>();
		return *_instance;
	}
	...
	unsigned BoxDebug::vao() const
	{
		return _vao;
	}

	void BoxDebug::render(const glm::vec3& color, const glm::mat4& model,
